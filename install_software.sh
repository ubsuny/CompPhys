...
pip3 install --upgrade pip && pip install --no-cache-dir matplotlib scipy==1.4.1 numpy scikit-learn keras tensorflow ipykernel ipython jupyter metakernel zmq notebook pytest nbval pandas pylint pycodestyle pycodestyle_magic flake8 Pillow
